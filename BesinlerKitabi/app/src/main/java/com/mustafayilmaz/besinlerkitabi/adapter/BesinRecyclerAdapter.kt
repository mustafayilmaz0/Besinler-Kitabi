package com.mustafayilmaz.besinlerkitabi.adapter
...
import com.mustafayilmaz.besinlerkitabi.databinding.BesinRecyclerRowBinding
import com.mustafayilmaz.besinlerkitabi.model.Besin
import com.mustafayilmaz.besinlerkitabi.view.BesinListesiFragmentDirections
...
class BesinRecyclerAdapter(val besinListesi: ArrayList<Besin>) :
    ...
    override fun onBindViewHolder(holder: BesinViewHolder, position: Int) {
        ...
        holder.itemView.imegeView.gorselIndir(besinListesi.get(position).besinGorsel, placeholderYap(holder.itemView.context))
 */
    }
